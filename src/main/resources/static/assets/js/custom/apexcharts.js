(async function () {
      ...
      series: [
        {
          name: "Lead",
          data: [
            8200, 8000, 8100, 8400, 8000, 8423, 8423, 8300, 8481, 8487, 8506,
            8626, 8668, 8602, 8607, 8512, 8496, 8600, 8881, 8500,
          ],
        },
      ],
      chart: {
      ...
      series: [
        {
          name: "Response Time",
          data: [
            51, 65, 54, 56, 37, 53, 62, 24, 35, 46, 39, 27, 38, 61, 45, 27, 54,
            93, 41, 31,
          ],
        },
      ],
      ...
      series: [
        {
          name: "Response Time",
          data: [
            41, 31, 35, 61, 46, 27, 47, 51, 54, 42, 24, 45, 55, 27, 39, 35, 56,
            62, 53, 52,
          ],
        },
      ],
  ...
  if (getTicketsByChannelId) {
    var options = {
      ...
      colors: ["#00cae3", "#796df6", "#0f79f3", "#ffb264"],
      yaxis: {
        show: false,
      },
      legend: {

...
public class EngineCheckDTO {
    ...
    public EngineCheckDTO() {
    }
    public EngineCheckDTO(Level oilLevel, Condition oilCondition, boolean oilFilter, boolean oilReplaced,
            Level coolantLevel, Condition coolantCondition, Level brakeFluidLevel, Condition brakeFluidColor,
            Level steeringFluid, Level gearFluid, Level washFluid, Condition engineStatus) {
